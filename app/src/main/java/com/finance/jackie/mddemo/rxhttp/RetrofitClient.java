...
import com.liangyue.commonlib.http.rxhttp.ApiService.HttpService;
...
//    }
    ...
    public HttpService createHttpApi() {
...
//                .compose(transformer())
    ...
    public static FlowableTransformer doApi(){
        return new FlowableTransformer() {
            @Override
            public Publisher apply(Flowable upstream) {
                return upstream.compose(schedulersTransformer())
                        .compose(bindToLifecycle(mContext));
            }
        };
    }
...
//    }
     ...
     */
    public static LifecycleTransformer bindToLifecycle(@android.support.annotation.NonNull Context lifecycle) {
     ...
     */
    public static <T> LifecycleTransformer bindToLifecycle(@android.support.annotation.NonNull Fragment lifecycle) {
        if (lifecycle instanceof LifecycleProvider) {
            return ((LifecycleProvider) lifecycle).bindToLifecycle();
        } else {
